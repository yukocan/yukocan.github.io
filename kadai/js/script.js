...
$('#list-1').accClass('current').siblings('li').removeClass('current');
}else if(y>=section2 && y<section3){
    //yがsection2以上かつsection3未満
    $('#list-2').accClass('current').siblings('li').removeClass('current');  
}else if(y>=section3 && y<section4){
    //yがsection3以上かつsection4未満
    $('#list-3').accClass('current').siblings('li').removeClass('current');
}else if(y>=section4 && y<section5){
    //yがsection4以上かつsection5未満
    $('#list-4').accClass('current').siblings('li').removeClass('current');
}else if(y>=section5 && y<section6){
     //yがsection5以上かつsection6未満
    $('#list-5').accClass('current').siblings('li').removeClass('current');
}else if(y>=section6){
    //yがsection6以上
    $('#list-6').accClass('current').siblings('li').removeClass('current');
}
